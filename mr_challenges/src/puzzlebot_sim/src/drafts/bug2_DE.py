    ...
    def main(self):
        while not rospy.is_shutdown():
            if self.regions is not None and self.cx is not None and self.cy is not None and self.yaw is not None:
                ...
                #print("Estado actual: ", self.state2)
                # print("Angulo: ", self.angle_to_goal)
                if self.state == "go-to-goal":
                    ...
                    elif self.obstacle_close() and self.state2 == 'no-turn' and self.point_cstate == "leave":
                    ...
                    # print("Distancia de la linea: ", distance_position_to_line)
                    # print("Estado actual: ", self.point_cstate)
                    if (distance_position_to_line < 0.2 or distance_position_to_line < 0.1) and distance_position_to_line > 0.001:
                        self.point_cstate = "leave"

                    if  self.point_cstate == "leave":
